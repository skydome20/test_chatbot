...
#================================= news_analysis ==============================================#
#==============================================================================================#
def news_summary(title_path, news_path, href_path, keep_ind):
	textnum = 0
	print(keep_ind)
    
	# 新聞標題
	f = open(title_path, 'r', encoding='utf-8')
	title_tmp = f.readlines()
	f.close()
	# 新聞超連結
	f = open(href_path, 'r', encoding='utf-8')
	href_tmp = f.readlines()
	f.close()
	# 新聞
	f = open(news_path, 'r', encoding='utf-8')
	news_tmp = f.readlines()
	f.close()
...
# keep news
	...
	for ind in keep_ind:
		title_table.append(title_tmp[ind])
		href_table.append(href_tmp[ind])
		news_table.append(news_tmp[ind])
        
	print("(新聞標題※摘要※超連結)" + "\n")

	for text in news_table:
